...
<div class="relative bg-white overflow-hidden">
            ...
            <main class="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div class="sm:text-center lg:text-left">
                    <h2 class="text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:text-5xl sm:leading-none md:text-6xl">
                        DON'T LET OTHERS KEEP TRACK OF
                        <br class="xl:hidden">
                        <span class="text-indigo-600">YOUR MONEY</span>
                    </h2>
                    <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                        Don't let other people's mistakes cost you money, keep track of your own billing. {{config('app.name')}} is a glorified personal income estimator which helps you know how much you made, before you get your check.
                        <br><br>
                        <span class="italic text-sm">
                            Oh, and it was created by a FirstFleet&trade; Driver. <a href="#" class="link">Learn more</a>
                        </span>
                    </p>
    ...
    <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="https://images.unsplash.com/photo-1562811950-41d4a4944a4b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80" alt="">
    </div>
</div>
