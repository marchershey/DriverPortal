...
<div class="min-h-screen flex items-center">
    <div class="w-full max-w-sm overflow-hidden mx-auto">
        <div class="py-4 px-6">
            ...
            <div class="mt-3 font-semibold text-xs text-gray-600">Sign into your account with your email and password, or you can sign in with a Facebook account.</div>
            <form class="mt-4" action="{{ route('login') }}" method="POST">
                ...
                <div class="flex justify-between items-center mt-4">
                    <label class="flex items-center">
                        ...
                        <span class="ml-2 text-xs text-gray-600">Stay signed in forever</span>
                    </label>
            ...
            <div class="mt-4 text-xs text-gray-500 text-center">
                <div class="flex items-center justify-center">
                    <h1 class="text-gray-600">Don't have an account?</h1>
                    <a href="/register" class="text-primary hover:text-primary-darker font-bold mx-2">Create one</a>
                </div>
                <p class="mt-4 text-gray-500">@lang('global.copyright')</p>
            </div>
        </div>
    </div>
</div>
