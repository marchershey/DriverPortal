<div class="form">
    ...
    <div class="group">
        <button type="button" class="button primary w-full" wire:click.prevent="submit" wire:loading.attr="disabled" wire:loading.class="bg-gray-300" wire:loading.value="Loading...">Continue</button>
    </div>
